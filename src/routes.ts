...
import { CreateProductWithExistsCategory } from './controllers/CreateProductWithExistsCategory';
...
const createProductCategoryExist = new CreateProductWithExistsCategory();
